...
namespace WhiteAds.API.Controllers
{
    ...
    {
        /// <summary>
        /// Método Para Mostrar por Lista de Horarios
        /// </summary>
        ...
        public HttpResponseMessage Get(int? page = 1, int? start = 0, int? limit = 20, string filter = "", string sort = "")
        {
            ...
            AppPagedResponse<List<HorariosModel>> response = new AppPagedResponse<List<HorariosModel>>() { Data = null };

            var db = horariosSvc.Load();
        ...
        /// <summary>
        /// Método para Mostrar Horarios por Id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        // GET: api/Horarios/5
        ...
        {
            AppResponse<HorariosModel> response = new AppResponse<HorariosModel>() { Data = null };
            var db = horariosSvc.Load(id);
        ...
        /// <returns></returns>
        public HttpResponseMessage Post([FromBody] HorariosModel value)
        {
            AppResponse<Horarios> response = new AppResponse<Horarios>() { Data = null };
            var db = horariosSvc.Save(MapToDB(value));
            response.Data = db;
            return Request.CreateResponse(HttpStatusCode.OK, response);
        }

        /// <summary>
        /// Método para Modificar Horarios
        /// </summary>
        /// <param name="id"></param>
        /// <param name="value"></param>
        // PUT: api/Horarios/5
        public HttpResponseMessage Put(int id, [FromBody] HorariosModel value)
        {
            AppResponse<Horarios> response = new AppResponse<Horarios>() { Data = null };
            var db = horariosSvc.Save(MapToDB(value));
            response.Data = db;
