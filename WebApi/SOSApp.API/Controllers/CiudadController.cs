...
namespace WhiteAds.API.Controllers
{
    ...
    {
        /// <summary>
        /// Método Para Mostrar por Lista de Ciudad
        /// </summary>
        ...
        public HttpResponseMessage Get(int? page = 1, int? start = 0, int? limit = 20, string filter = "", string sort = "")
        {
            ...
            AppPagedResponse<List<CiudadModel>> response = new AppPagedResponse<List<CiudadModel>>() { Data = null };

            var db = ciudadSvc.Load();
        ...
        /// <summary>
        /// Método para Mostrar Ciudad por Id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        // GET: api/Ciudad/5
        ...
        {
            AppResponse<CiudadModel> response = new AppResponse<CiudadModel>() { Data = null };
            var db = ciudadSvc.Load(id);
        ...
        /// <returns></returns>
        // POST: api/Ciudad
        public HttpResponseMessage Post([FromBody] CiudadModel value)
        {
            AppResponse<Ciudad> response = new AppResponse<Ciudad>() { Data = null };
            var db = ciudadSvc.Save(MapToDB(value));
            response.Data = db;
            return Request.CreateResponse(HttpStatusCode.OK, response);
        }

        /// <summary>
        /// Método para Modificar Ciudad
        /// </summary>
        /// <param name="id"></param>
        /// <param name="value"></param>
        // PUT: api/Ciudad/5
        public HttpResponseMessage Put(int id, [FromBody] CiudadModel value)
        {
            AppResponse<Ciudad> response = new AppResponse<Ciudad>() { Data = null };
            var db = ciudadSvc.Save(MapToDB(value));
            response.Data = db;
